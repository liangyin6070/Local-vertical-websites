...
public class AliyunLogUtils {
	private static Logger log = Logger.getLogger(AliyunLogUtils.class);
	 ...
	 * @param now 写入时间
	 */
	public static void writeJsonLogs(String index, String topic, String[] keys, Object[] values, Date now) {
	 ...
	 * @param source
	 */
	private static void writeLogs(String index, String topic, String source, Date now) {
